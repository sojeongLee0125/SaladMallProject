                                ...
                                <table id="example2"
                                    ...
                                    <tr role="row">
                                        <th class="sorting_asc" tabindex="0" aria-controls="example2"
                                            ...
                                            aria-label="Rendering engine: activate to sort column descending">글번호
                                        </th>
                                        ...
                                        <th class="sorting_asc" tabindex="0" aria-controls="example2"
                                            rowspan="1" colspan="1" aria-sort="ascending"
                                            aria-label="Rendering engine: activate to sort column descending">회원아이디
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example2"
                                            rowspan="1" colspan="1"
                                            aria-label="Browser: activate to sort column ascending">레시피번호
                                        </th>
                                    ...
                                    <c:forEach var="rbvo" items="${RBoard_TopList }">
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <a href="${pageContext.request.contextPath }/R_Board/board_detail?rcp_b_num=${rbvo.rcp_b_num }">${rbvo.rcp_b_title }</a>
                                            </td>
                                            <td>${rbvo.m_id }</td>
                                            <td>${rbvo.rcp_num }</td>
