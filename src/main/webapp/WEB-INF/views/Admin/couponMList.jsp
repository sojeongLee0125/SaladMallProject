...
<section class="content" style="padding-top: 50px; padding-bottom: 130px;">
                                    ...
                                    <c:forEach var="cmvo" items="${couponMList }">
                                        <tr role="row" class="odd">
                                            <td class="sorting_1"><a
                                                    href="${pageContext.request.contextPath }/Admin/mInfo?m_id=${cmvo.m_id }&pageNum=1">${cmvo.m_id }</a>
                                            </td>
                                            <td>${cmvo.m_name }</td>
                                            <c:choose>
    ...
    <!-- /.row -->
    <div class="btn-group" role="group" style="text-align:center; padding: 0px 0px 350px 15px;"
