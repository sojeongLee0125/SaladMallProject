            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="order_num" name="order_num"
                           value=${ovo.order_num } disabled="disabled">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" readonly="readonly" class="form-control" id="coupon_id" name="coupon_id"
                           value=${ovo.coupon_id }>
                </div>
                <div class="form-group">
                    <label for="order_pay_num">결제번호</label>
                    <input type="text" class="form-control" id="order_pay_num" name="order_pay_num"
                           value=${ovo.order_pay_num }>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="order_date" name="order_date"
                           value=${ovo.order_date } disabled="disabled">
                </div>
                <div class="form-group">
                    <label for="order_receive_name">수취인 이름</label>
                    <input type="text" class="form-control" id="order_receive_name" name="order_receive_name"
                           value=${ovo.order_receive_name }>
                </div>
                <div class="form-group">
                    <label for="order_receive_phone">수취인 전화번호</label>
                    <input type="text" class="form-control" id="order_receive_phone" name="order_receive_phone"
                           value=${ovo.order_receive_phone }>
                </div>
                <div class="form-group">
                    <label for="order_receive_zip">수취인 우편번호</label>
                    <input type="text" class="form-control" id="order_receive_zip" name="order_receive_zip"
                           value=${ovo.order_receive_zip }>
                </div>
                <div class="form-group">
                    <label for="order_receive_addr1">수취인 주소</label>
                    <input type="text" class="form-control" id="order_receive_addr1" name="order_receive_addr1"
                           value=${ovo.order_receive_addr1 }>
                </div>
                <div class="form-group">
                    <label for="order_receive_addr2">수취인 상세주소</label>
                    <input type="text" class="form-control" id="order_receive_addr2" name="order_receive_addr2"
                           value=${ovo.order_receive_addr2 }>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="order_amount" name="order_amount"
                           value=${ovo.order_amount }>
                </div>
                <div class="form-group">
                    <label for="order_ship_price">배송비</label>
                    <input type="text" class="form-control" id="order_ship_price" name="order_ship_price"
                           value=${ovo.order_ship_price }>
                </div>
                <div class="form-group">
                    <label for="order_total_price">결제 금액</label>
                    <input type="text" class="form-control" id="order_total_price" name="order_total_price"
                           value=${ovo.order_total_price }>
                </div>
                <div class="form-group">
                    <label for="order_status">주문 상태</label>
                    <input type="text" class="form-control" id="order_status" name="order_status"
                           value=${ovo.order_status }>
                </div>
