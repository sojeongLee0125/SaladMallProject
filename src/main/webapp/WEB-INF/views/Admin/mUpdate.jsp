            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="m_id" name="m_id"
                           value=${mvo.m_id } disabled="disabled">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="m_totalAmount" name="m_totalAmount"
                           value=${mvo.m_totalAmount }>
                </div>
                <div class="form-group">
                    <label for="m_attendance">출석일수</label>
                    <input type="text" class="form-control" id="m_attendance" name="m_attendance"
                           value=${mvo.m_attendance }>
                </div>
                <div class="form-group">
