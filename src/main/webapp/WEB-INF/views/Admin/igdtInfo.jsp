        ...
        <div class="box-body table-responsive">
            <table class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <!-- 메인 이미지 파일  -->
                    <td><img style="width: 70px; height: 35px;"
                             src="${pageContext.request.contextPath}/resources/upload/${ivo.igdt_main_img}"/></td>
                    <!-- 보조 이미지 파일 -->
                    <td><img style="width: 70px; height: 35px;"
                             src="${pageContext.request.contextPath}/resources/upload/${ivo.igdt_sub_img}"/></td>
