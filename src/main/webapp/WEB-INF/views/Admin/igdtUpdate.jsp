            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="igdt_num" name="igdt_num"
                           value=${ivo.igdt_num } disabled="disabled">
                </div>
                <div class="form-group">
                    <label>재료 카테고리</label>
                    <select name="igdt_category" class="form-control">
                        <option value="1" <%=pageContext.getAttribute("category").toString().equals("1") ? " selected" : ""%>>
                            야채
                        </option>
                        <option value="2" <%=pageContext.getAttribute("category").toString().equals("2") ? " selected" : ""%>>
                            고기
                        </option>
                        <option value="3" <%=pageContext.getAttribute("category").toString().equals("3") ? " selected" : ""%>>
                            해산물
                        </option>
                        <option value="4" <%=pageContext.getAttribute("category").toString().equals("4") ? " selected" : ""%>>
                            소스
                        </option>
                        <option value="5"<%=pageContext.getAttribute("category").toString().equals("5") ? " selected" : ""%>>
                            기타
                        </option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="igdt_main_img" name="igdt_main_img"
                           value=${ivo.igdt_main_img }>
                    <input type="hidden" class="form-control" id="igdt_sub_img" name="igdt_sub_img"
                           value=${ivo.igdt_sub_img }>
                </div>
                <div class="form-group">
                    <label for="igdt_country">원산지</label>
                    <input type="text" class="form-control" id="igdt_country" name="igdt_country"
                           value=${ivo.igdt_country }>
                </div>
                <div class="form-group">
