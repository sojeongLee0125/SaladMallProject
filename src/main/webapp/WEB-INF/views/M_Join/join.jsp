                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="checkout__input">
                            ...
                            <p class="idCheck" style="margin-bottom:0;"><span class="idCheckMsg"
                                                                              style="font-size:12px; font-weight:bold;"></span>
                            </p>
                            <button type="button" class="btn btn-primary modalModBtn" style="visibility: hidden;"
                                    id="id_dupli_use">사용 하기
                            </button>
                    ...
                    <div class="col-lg-12">
                        <div class="checkout__input">
                            ...
                            <p class="pw1Check" style="margin-bottom:0;"><span class="pw1CheckMsg"
                                                                               style="font-size:12px; font-weight:bold;"></span>
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="checkout__input">
                            ...
                            <p class="pw2Check" style="margin-bottom:0;"><span class="pw2CheckMsg"
                                                                               style="font-size:12px; font-weight:bold;"></span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="checkout__input">
                            <p>전화번호<span>*</span></p>
                            <input type="text" class="user_input" name="m_phone" id="m_phone"
                                   placeholder="010-0000-0000">
                            <p class="phoneCheck" style="margin-bottom:0;"><span class="phoneCheckMsg"
                                                                                 style="font-size:12px; font-weight:bold;"></span>
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="checkout__input ">
                            ...
                            <div class="join_btn">
                                ...
                                <p class="emailCheck" style="margin-bottom:0;"><span class="emailCheckMsg"
                                                                                     style="font-size:12px; font-weight:bold;"></span>
                                </p>
                    ...
                    <div class="col-lg-12">
                        <div class="checkout__input" id="mail_check_input_box">
                            ...
                            <p class="cknumCheck" style="margin-bottom:0;"><span class="cknumCheckMsg"
                                                                                 style="font-size:12px; font-weight:bold;"></span>
                            </p>
                    ...
                    <div class="col-lg-12">
                        <div class="checkout__input">
                            <p>우편번호<span>*</span></p>
                            <div class="join_btn">
                                <input type="text" class="address_input_1" name="m_zip" id="m_zip" onclick="addrclick()"
                                       readonly="readonly">
