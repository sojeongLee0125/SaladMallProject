                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="checkout__input">
                            ...
                            <input readonly name="order_receive_addr1" id="m_addr1" type="text"
                                   placeholder="Street Address" class="checkout__input__add" value="${member.m_addr1}">
                            <input name="order_receive_addr2" id="m_addr2" type="text"
                                   placeholder="Apartment, suite, unite ect (optinal)" value="${member.m_addr2}">
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="checkout__input">
                        ...
                        <p>Create an account by entering the information below. If you are a returning customer
                            please log in at the top of the page</p>
                        <div class="checkout__input">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12" id="kakao_pay_view">
                                ...
                                <div class="checkout__input__radio">
                                    ...
                                    <label class="box-radio-input"><input type="radio" name="cp_item"
                                                                          value="25000"><span>25,000원</span></label>
                                    <label class="box-radio-input"><input type="radio" name="cp_item"
                                                                          value="30000"><span>30,000원</span></label>
                                    <label class="box-radio-input"><input type="radio" name="cp_item"
                                                                          value="35000"><span>35,000원</span></label>
                                    <label class="box-radio-input"><input type="radio" name="cp_item"
                                                                          value="40000"><span>40,000원</span></label>
                                    <label class="box-radio-input"><input type="radio" name="cp_item"
                                                                          value="50000"><span>50,000원</span></label>
                                    <p style="color: #ac2925; margin-top: 30px">카카오페이의 최소 충전금액은 5,000원이며 <br/>최대 충전금액은
                                        50,000원 입니다.</p>
