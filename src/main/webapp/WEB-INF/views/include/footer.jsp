                ...
                <div class="col-lg-2 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.jsp"><img src="${pageContext.request.contextPath }/resources/saladmall/img/logo.png" alt=""></a>
                        </div>
                        <!-- <ul>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Copyright © 2021 이소정, 문석호, 김창진, 이기동, 노아영, 김보혜, 전종락, 이유화<br>All rights reserved.</a></li>
                        </ul>
                    </div>
                </div>
