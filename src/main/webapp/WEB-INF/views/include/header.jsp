...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/saladmall/css/bootstrap.min.css"
          type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/saladmall/css/font-awesome.min.css"
          type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/saladmall/css/elegant-icons.css"
          type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/saladmall/css/nice-select.css"
          type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/saladmall/css/jquery-ui.min.css"
          type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/saladmall/css/owl.carousel.min.css"
          type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/saladmall/css/slicknav.min.css"
          type="text/css">
...
<div class="humberger__menu__wrapper">
    ...
    <div class="humberger__menu__cart">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath }/Basket/basket"><i class="fa fa-shopping-bag"></i>
                <span>3</span></a></li>
        </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="header__top__right">
                        ...
                        <div class="header__top__right__auth">
                            <c:if test="${m_id == null }">
                                <a href="${pageContext.request.contextPath }/M_Login/login"><i class="fa fa-user"></i>
                                    Login</a>
                            </c:if>
                            <c:if test="${m_id != null }">
                                <a href="${pageContext.request.contextPath }/M_Login/logout"><i class="fa fa-user"></i>
                                    Logout</a>
                            </c:if>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="header__cart">
                    <ul>
                        <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                        <li><a href="${pageContext.request.contextPath }/Basket/basket"><i
                    ...
                    <div class="hero__search__form">
                        <form action="#">
                            ...
                            <div class="hero__search__input">
                                <input type="text" placeholder="What do yo u need?" id="total_search_data"
                                       autocomplete="off">
