    ...
    <div class="container">
        <div class="common__form">
            ...
            <form action="" method="post" name="registerform">
                <div class="row">
                    <div class="col-lg-6">
                        <input type="hidden" name="customer_b_num" class="form-control" id="CS_Board6"
                               value="${cvo.customer_b_num }">
                ...
                <div class="common__input">
                    <p>글내용</p>
                    <textarea name="customer_b_content" id="content" rows="15" cols="155" name="customer_b_content"
                              style="resize: none;">${cvo.customer_b_content }" </textarea>
                </div>
            </form>
        </div>
