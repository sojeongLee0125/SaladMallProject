            ...
            <div class="row">
				...
				<c:forEach var="vo" varStatus="status" items="${ingredientList }">
                    ...
                    <div class="shoping__cart__btns">
                        <a href="#" class="primary-btn cart-btn" onclick="location.href='${pageContext.request.contextPath }/R_Custom/step1'">Previous</a>
                        <a href="#" class="primary-btn cart-btn cart-btn-right"  value="다음" onclick="location.href='${pageContext.request.contextPath }/R_Custom/step3'">
                        	Next
                        </a>                   
                    </div>
                </div>
