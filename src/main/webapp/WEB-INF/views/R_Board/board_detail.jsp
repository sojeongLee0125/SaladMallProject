                        ...
                        <div class="col-lg-6">
                            <div class="blog__details__widget">
                                ...
                                <div class="blog__details__social">
                                    ...
                                    <a href="./likeCheck?rcp_b_num=${board.board.rcp_b_num }"><i
                                            class="fa fa-heart"></i></a>
                                    <input id="likeCheck" type="hidden" value="${like }">
                                </div>
                                <div class="checkout__input__radio" id="controll_btn">
                                    <input class="site-btn" type="button" value="수정하기"
                                           onclick="location.href='./boardModify?rcp_b_num=${board.board.rcp_b_num}'">
                                    <input class="site-btn" type="button" value="삭제하기"
                                           onclick="location.href='../R_Board/boardDelete?rcp_b_num=${board.board.rcp_b_num}'">
                                </div>
                            </div>
                        </div>
                    </div>
